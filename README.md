# Dragon Ball Legends Team Guide Builder
...
- Backend routing and REST API structure using Flask
- Rule-based filtering system for generating team archetypes
- Structured data model for characters and equipment attributes
